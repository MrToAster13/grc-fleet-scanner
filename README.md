...
> ℹ️ **Status:** functional and tested offline (58-test suite). The live SSH → OpenSCAP
...
python -m pytest        # expect: 58 passed
...
Issues and PRs welcome. Run `python -m pytest` (58 tests) before submitting; keep the
