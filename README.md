...
> ℹ️ **Status:** functional and tested offline (88-test suite). The live SSH → OpenSCAP
...
python -m pytest        # expect: 88 passed
...
Issues and PRs welcome. Run `python -m pytest` (88 tests) before submitting; keep the
