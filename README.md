...
> ℹ️ **Status:** functional and tested offline (78-test suite). The live SSH → OpenSCAP
...
Issues and PRs welcome. Run `python -m pytest` (78 tests) before submitting; keep the
