...
> ℹ️ **Status:** functional and tested offline (52-test suite). The live SSH → OpenSCAP
...
python -m pytest        # expect: 52 passed
...
Issues and PRs welcome. Run `python -m pytest` (52 tests) before submitting; keep the
