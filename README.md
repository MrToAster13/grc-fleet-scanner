...
> ℹ️ **Status:** functional and tested offline (86-test suite). The live SSH → OpenSCAP
...
Issues and PRs welcome. Run `python -m pytest` (86 tests) before submitting; keep the
