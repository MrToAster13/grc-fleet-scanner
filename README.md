...
> ℹ️ **Status:** functional and tested offline (77-test suite). The live SSH → OpenSCAP
...
python -m pytest        # expect: 77 passed
...
Issues and PRs welcome. Run `python -m pytest` (77 tests) before submitting; keep the
