...
> ℹ️ **Status:** functional and tested offline (96-test suite). The live SSH → OpenSCAP
...
Issues and PRs welcome. Run `python -m pytest` (96 tests) before submitting; keep the
