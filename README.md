...
> ℹ️ **Status:** functional and tested offline (75-test suite). The live SSH → OpenSCAP
...
python -m pytest        # expect: 75 passed
...
Issues and PRs welcome. Run `python -m pytest` (75 tests) before submitting; keep the
